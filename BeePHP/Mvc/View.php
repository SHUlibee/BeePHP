...
use BeePHP\Mvc\View\Compile;

class View{

    private $arrayConfig = array(
        'suffix' 		=> '.tpl',		//模板的后缀
        'templateDir' 	=> 'View/',     //模板所在的文件夹
    ...
    public function getPath(){
        $this->arrayConfig['templateDir'] = SERVER_ROOT . '/' . $this->arrayConfig['templateDir'];
        $this->arrayConfig['compileDir'] = SERVER_ROOT . '/' . $this->arrayConfig['compileDir'];
	}
